...
// feima-lab 从 Next.js 迁到 React Router v7 后，目录从 src/ → app/
const MDX_DIR = join(FEIMA_LAB, 'app/components/mdx');
const ARTICLE_CSS = join(FEIMA_LAB, 'app/styles/article.css');
const GLOBALS_CSS = join(FEIMA_LAB, 'app/app.css');
